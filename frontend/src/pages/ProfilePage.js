    ...
    <div>
      ...
      <div className="top-bar">
        <div className="welcome">
          {" "}
          Welcome to Projectathon,{" "}
          <span id="highlightLP"> {userInfo?.username} </span>{" "}
        </div>
      </div>

      {/* Skill Level */}
      <div className="profile-section">
        <h2> Skill Level</h2> <p>{userInfo?.skillLevel}</p>
      </div>

      {/* Programming Languages */}
      <div className="profile-section">
        {" "}
        <h2>Programming Languages</h2> <p> {userInfo?.languages.join(", ")} </p>
      </div>

      {/* Interests */}
      <div className="profile-section">
        <h2>Interests</h2> <p>{userInfo?.interests.join(", ")}</p>
      </div>
      ...
      <div className="profile-section">
        <h3>
          View your <span id="highlightBl">collection</span> of project ideas by
      ...
      <div className="profile-section">
        <h3>
          View your <span id="highlightBl">new project ideas</span> by clicking
          the button below
        </h3>
