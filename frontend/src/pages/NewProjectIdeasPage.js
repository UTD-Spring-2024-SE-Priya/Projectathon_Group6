          ...
          {projectIdeas.map((idea, index) => (
            <div key={index} className="project-card">
              ...
              <div className="icons-container">
                <button className="icon-button" onClick={() => handleLike(index)}>
                <FontAwesomeIcon icon={faHeart} className={`heart-icon ${likes[index] ? 'liked' : ''}`} />
                </button>
                <button onClick={() => handleComment(index)} className="icon-button">
